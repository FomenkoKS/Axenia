...
return array(
    ...
    "chat.help" =>
        array(
            "en" => "Write plus (+ or 👍) replying to any message for raising karma or minus (- or 👎) to lower the karma.
I support messages with format \"+ @username\". Also I ignore another bot.
Use \"/top\" to see statistics of top in this chat.
Use \"/mystats\" to see your global statistics.
Use \"/lang\" to change language.
Also you can buy some pictures (cats, etc) on your karma, use \"/buy\"
...
Также понимаю сообщение формата \"+ @username\". Игонрирую подсчет кармы для ботов.
