...
Оценить бота t.me/storebot?start=axenia_bot"
    ...
    "settings.erase" => [
        "en" => '💀 ' . "Erase all karma from group (10🍪)",
        "ru" => '💀 ' . "Удалить всю карму из группы (10🍪)",
        "ruUN" => '💀 ' . "Удалить всю карму из группы (10🍪)"
    ],
    ...
    "donate.terms" => [
        "en" => "<b>Terms and Conditions</b>\r\n\r\n1. All transfers are donations from users for the development of the project. \r\n2. As a token of gratitude, users receive the project's conventional currency - cookies, denoted by the 🍪 symbol.\r\n3. To get help, the user can use the command /support.",
        "ru" => "<b>Условия и положения</b>\r\n\r\n1. Все переводы являются пожертвованиями пользователей на развитие проекта. \r\n2. В знак благодарности пользователи получают условную валюту проекта - печеньки, обозначающимся знаком 🍪. \r\n3. Для получения помощи пользователь может воспользоваться командой /support. ",
        "ruUN" => "<b>Условия и положения</b>\r\n\r\n1. Все переводы являются пожертвованиями пользователей на развитие проекта. \r\n2. В знак благодарности пользователи получают условную валюту проекта - печеньки, обозначающимся знаком 🍪. \r\n3. Для получения помощи пользователь может воспользоваться командой /support."
    ],
    "donate.support" => [
        "en" => "Write to @axenia_support for support.",
        "ru" => "В случае проблем, пожалуйста, напишите в группу @axenia_support. Там вам помогут.",
        "ruUN" => "Если что-то пошло не так, то напишите нам в группу @axenia_support. Мы вас поддержим добрым словом."
    ],
    "donate.bill" => [
    ...
    "donate.notEnough" => [
        "en" => "Not enough cookies. Press /donate for get it.",
        "ru" => "Извините, у вас не хватает печенек для этого функционала. Выберите команду /donate, чтобы пополнить печеньки.",
        "ruUN" => "Сорян, без печенек я ничего делать не буду. Купить их можешь с помощью команды /donate."
    ],
    "confirm.yes" => [
        "en" => "Yes",
        "ru" => "Да",
